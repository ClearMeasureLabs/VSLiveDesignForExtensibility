...
task Compile -depends Init {
    exec {
        & msbuild /t:Clean`;Rebuild /v:d /maxcpucount:1 /nologo /p:Configuration=$projectConfig /p:OctoPackPackageVersion=$version /p:RunOctoPack=$runOctoPack /p:OctoPackEnforceAddingFiles=true $source_dir\$projectName.sln
    }
